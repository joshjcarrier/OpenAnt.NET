namespace OpenAnt.Entity.Terrain
{
    ...
    public static class TerrainEntity
    {
        ...
        {
            var baseEntity = new GameEntityBase(new Rectangle(position.X, position.Y, 1, 1), null);
        ...
        {
            var baseEntity = new GameEntityBase(new Rectangle(position.X, position.Y, size, size), null);
            baseEntity = new StaticRenderEntity(baseEntity, texture);
